        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <img src={APP_LOGO} className="block" width="40" height="40" alt={`${APP_NAME} Logo`} />
          ...
          <div>
            ...
            <nav className="space-y-2">
              ...
              <Link to="/organization" className="block text-gray-300 hover:text-white transition-colors">
                Organizations
              </Link>
              <Link to="/query" className="block text-gray-300 hover:text-white transition-colors">
                Search
              </Link>
            </nav>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a 
                href="mailto:admin@correlation-apps.net" 
